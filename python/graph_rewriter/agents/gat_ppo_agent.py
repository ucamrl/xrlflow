...
from graph_rewriter.agents.base_agent import (_BaseAgent, compute_gae,
                                              action_from_logits,
                                              masked_logits)
from graph_rewriter.agents.models import PPO_GAT_model, PPO_GAT_model_v2, PPO_GAT_model_v4, PPO_GAT_model_v5, PPO_GAT_model_v6


class GATPPO(_BaseAgent):
    ...
    def __init__(
        ...
        # main_model = PPO_GAT_model(num_head, hidden_dim, message_passing_steps,
        #                            gat_global_update_mlp, policy_feature,
        #                            vf_feature)
        main_model = PPO_GAT_model_v4(gat_attn_mlp, gat_node_update_mlp,
                                      message_passing_steps,
                                      gat_global_update_mlp, policy_feature,
                                      vf_feature, num_candidates)
        # main_model = PPO_GAT_model_v5(gat_attn_mlp, gat_node_update_mlp,
        #                               message_passing_steps,
        #                               gat_global_update_mlp, policy_feature,
        #                               vf_feature, num_candidates)
        # main_model = PPO_GAT_model_v6(gat_attn_mlp, gat_node_update_mlp,
        #                               message_passing_steps,
        #                               gat_global_update_mlp, policy_feature,
        #                               vf_feature, num_candidates)
