...
if __name__ == '__main__':
    graph = ts.new_graph()
    graph_input = graph.new_input(dims=(1, 3, 224, 224))
    weight = graph.new_weight(dims=(64, 3, 7, 7))
    t = graph.conv2d(input=graph_input,
                     weight=weight,
                     strides=(2, 2),
                     padding="SAME",
                     activation="RELU")
    ...
    export_onnx(graph, "output-data/graphs/resneXt_50.onnx")
